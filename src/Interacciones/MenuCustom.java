 ...
 * Permite al usuario interactuar con un menú para seleccionar y gestionar diferentes tipos de vehículos.
 */
public class MenuCustom implements MenuStep1, Robable {
         ...
         * Permite al usuario seleccionar un tipo de vehículo, ingresar sus datos y realizar operaciones con él.
         */
                ...
                do {
                                ...
                                // ADICION OPCION 2 SUBMENU CUSTOMIZABLE
                                                ...
                                                for (int i = 0; i < zonasProvincia2.size(); i++) {
                                                                System.out.println((BLUE+(i + 1)) + ". " + GREEN + zonasProvincia2.get(i)+RESET);
                                                }
                                ...
                                //CONDICIONAL PARA MOSTRAR EN PANTALLA EL METODO DESCRIBIR() DE ACUERDO AL VEHICULO INGRESADO POR USUARIO
                                                ...
                                                switch (vehiculo) {
                                                                case 1:
                                                                                ...
                                                                                + provincias.get(provinciaId - 1) +GREEN+ " y en la zona de " +PURPLE+ zonas.get(provinciaId-1).get(zonaId-1)+RESET);
                                                                                break;
                                                                ...
                                                                case 3:
                                                                                ...
                                                                                userShip.describir();
                                                                                System.out.println(GREEN+"Se encuentra en la provincia de "+ CYAN + provincias.get(provinciaId - 1) +GREEN+ " y en la zona de "+PURPLE+zonas.get(provinciaId-1).get(zonaId-1)+RESET);
                                                                                break;
